$(document).ready(function(){
	...
	*/
	...
	/*
		At the top of page there is a search box
		 when user put name of product 
		then i will take the given string 
	*/
	...
	*/
	...
	/*
		Whenever user change qty  immediate update their total amount by using keyup funtion
		but whenever user put something(such as ?''"",.()''etc) other than number then  make qty=1
		if user put qty 0 or less than 0 then  again make it 1 qty=1
	...
	*/
	...
	/*
		whenever user click on .remove class : take product id of that row 
	...
	*/
	...
	/*
		whenever user click on .update class : take product id of that row 
