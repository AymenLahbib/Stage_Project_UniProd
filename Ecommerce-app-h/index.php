	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		...
		<div class="collapse navbar-collapse" id="collapse">
			<ul class="nav navbar-nav">
				...
				<li style="top:10px;left:20px;"><button class="btn btn-primary" id="search_btn"><span class="glyphicon glyphicon-search"></span> Search</button></li>
			</ul>
					...
					<div class="panel-body">
						...
						<!--<div class="col-md-4">
							<div class="panel panel-info">
								...
								<div class="panel-heading">DT.500.00
